...
- **Frontend**: Aplicación web responsiva con páginas de inicio, login y registro. Incluye herramientas para generar materiales pedagógicos alineados al Currículo Nacional (CNEB).
- **Backend**: API REST con autenticación JWT, gestión de usuarios, cursos y matrículas. Documentación OpenAPI/Swagger.
